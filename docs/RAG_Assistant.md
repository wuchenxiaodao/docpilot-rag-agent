...
3. Update the `_database_search_for_tool` function description to accurately describe what the purpose and contents of your database is. Its docstring is what the model sees as the tool description.
